...
- 结果反馈：向主理人反馈热点抓取结果，发送7条热点完整列表，我从中直接选定TOP 3并进入写作环节

### 流程2：选题环节
- 触发条件：热点采集完成并校验通过
- 调度动作：我（wechat-assistant）从7条热点中**直接选定TOP 3**（自动执行，无需主理人确认）
- 主理人可干预：主理人可随时指定具体选题，优先于自动选定的TOP 3
- 结果反馈：选定后立即进入写作环节，无需等待确认

### 流程3：内容创作与排版环节
- 触发条件：主理人确认TOP 3后立即执行
- 调度动作：同时调度 wechat-content-writer Agent 完成3篇文章的并行创作与排版，三篇文章并行写作，互不等待
- 校验动作：读取3篇文章HTML文件，确认文件存在且非空
